...
namespace KurumsalMimari.Core.CrossCuttingConcerns.Security.Web
{
    public class AuthenticationHelper
    {
        ...
        private static string CreateAuthTags(string email, string[] roles, string firstName, object lastName, Guid id)
        {
